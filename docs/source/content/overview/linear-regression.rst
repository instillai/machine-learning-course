...
.. figure:: _img/LR.png
   ...
   **Figure 1. A sample data set with a linear relationship** [`code`__]
   ...
   .. __: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/linear_regression.py
...
.. figure:: _img/LR_LOBF.png
   ...
   **Figure 2. The data set from Figure 1 with a line of best fit** [`code`__]
   ...
   .. __: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/linear_regression_lobf.py
...
.. figure:: _img/Not_Linear.png
   ...
   **Figure3. A sample data set without a linear relationship** [`code`__]
   ...
   .. __: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/not_linear_regression.py
...
.. figure:: _img/Exponential.png
   ...
   **Figure 4. A sample data set that follows an exponential curve** [`code`__]
   ...
   .. __: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/exponential_regression.py
...
.. figure:: _img/Exponential_Transformed.png
   ...
   **Figure 5. The data set from Figure 4 after applying a logarithm to the 
   ...
   .. __: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/exponential_regression_transformed.py
...
.. figure:: _img/Cost.png
   ...
   **Figure 6. The plot from Figure 2 with the cost of one prediction 
   ...
   .. __: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/linear_regression_cost.py
...
.. _linear_regression_lobf.py: https://github.com/machinelearningmindset/python-machine-learning/blob/master/code/overview/linear_regression/linear_regression_lobf.py
